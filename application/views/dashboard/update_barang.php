            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-color.html">Buat Transaksi</a>
                        <a class="collapse-item" href="utilities-border.html">Daftar Transaksi</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- basic card example ukuran width setengah dan berada di tengah-->
                    <div class="card shadow mb-4" style="width: 50%; margin: auto;">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Tambah Data</h6>
                        </div>
                        <div class="card-body">
                            <!-- // alert danger ketika flashdata error -->
                            <?php if ($this->session->flashdata('error')) : ?>
                            <div class="alert alert-danger" role="alert">
                                <?= $this->session->flashdata('error') ?>
                            </div>
                            <?php endif; ?>
                            <form action="<?= base_url('dashboard/update_barang') ?>" method="post">
                                <div class="form-group">
                                    <input type="hidden" value="<?= $data->no ?>" name="no">
                                    <label for="kode_barang">Kode Barang</label>
                                    <input type="text" class="form-control" value="<?= $data->kode_barang ?>"
                                        id="kode_barang" name="kode_barang" required readonly>
                                    <div class="mt-3"></div>
                                    ...
                                    <input type="number" class="form-control" value="<?= $data->harga_beli ?>"
                                        id="harga_beli" name="harga_beli" required>
                                    <div class="mt-3"></div>
                                    ...
                                    <div class="mt-3"></div>
                                    <button type="submit" class="btn btn-primary mt-3" name="simpan" value="true">Update
                                        Data</button>
