                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4" style="width: 50%; margin: auto;">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('dashboard/tambah_user') ?>" method="post">
                            ...
                            <form action="<?= base_url('dashboard/tambah_user') ?>" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="mt-3"></div>
                                    <button type="submit" class="btn btn-primary mt-3" name="simpan" value="true">Tambah
                                        User</button>
                                    <a href="<?= base_url('/dashboard/user') ?>" class="btn btn-danger mt-3">Kembali</a>
                                </div>
                            </form>
                            <?php } ?>
                        </div>
